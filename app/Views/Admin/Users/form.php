  ...
  <div class="field">
    <label class="checkbox" for="is_active">
      <?php if($user->id === current_user()->id): ?>
        <input type="checkbox" id="is_active" name="is_active" value="1" checked disabled> active
      <?php else: ?>
  ...
  <div class="field">
    <label class="checkbox" for="is_admin">
      <?php if($user->id === current_user()->id): ?>
        <input type="checkbox" id="is_admin" name="is_admin" value="1" checked disabled> administrator
      <?php else: ?>
